import AccountService from '@sbc/services/account.services'
import ConfigHelper from '@sbc/util/config-helper'
import { SessionStorageKeys, LoginSource, Role } from '@sbc/util/constants'
import UserService from '@sbc/services/user.services'
import { getAccountIdFromCurrentUrl } from '@sbc/util/common-util'
import KeyCloakService from '@sbc/services/keycloak.services'
import { defineStore } from 'pinia'
import { AccountStateIF } from '@sbc/interfaces'
import { KCUserProfile } from '@sbc/models/KCUserProfile'
import { UserSettings } from '@sbc/models/userSettings'
import { UserProfile } from '@sbc/models/UserProfile'
